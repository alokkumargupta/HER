...
public class UiUtils {
	...
	public static float getDeviceResolution ( Context activity ) {
...
public static float getDeviceDensity(Activity activity)
{
	...
	/**
	 * Create circular cropped Bitmap from given Bitmap.
	 * @param bitmap
	 * @return circular cropped bitmap
	 */
	public static Bitmap getCroppedBitmap(Context context, Bitmap bitmap,boolean isRounded)
	{
		...
		RectF rectF = new RectF(0, 0, rad, rad);
		...
		//canvas.drawCircle(rad / 2, rad / 2, rad / 2, paint);
		//paint.setXfermode(new PorterDuffXfermode(Mode.SRC_IN));
		if(isRounded){
			canvas.drawRoundRect(rectF,UiUtils.GetDipsFromPixel(20, context),UiUtils.GetDipsFromPixel(20, context),paint);
		}else{
			canvas.drawRoundRect(rectF,UiUtils.GetDipsFromPixel(0, context),UiUtils.GetDipsFromPixel(0, context),paint);
		}
	...
	public static Bitmap getScaleBitmap(Context context, Bitmap _bitmap,boolean isRounded){
		
	//	int rad = bitmap.getWidth() <= bitmap.getHeight() ? bitmap.getWidth() : bitmap.getHeight();
		Bitmap bitmap  = Bitmap.createScaledBitmap(_bitmap, UiUtils.GetDipsFromPixel(70, context),UiUtils.GetDipsFromPixel(60, context), true);
		Bitmap output = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Config.ARGB_8888);
    ...
    public static int getPX(float dp,Context context) {
