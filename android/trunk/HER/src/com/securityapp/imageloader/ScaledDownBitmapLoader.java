...
/**
 * @author rupesh.rastogi
 *use this for image scaling 
 *if you want to display image of size 250x250 whereas the actual image dimesion is 2048x2367
...
public class ScaledDownBitmapLoader {
	...
	public static Bitmap decodeSampledByteArray(byte[] res, int offset,
