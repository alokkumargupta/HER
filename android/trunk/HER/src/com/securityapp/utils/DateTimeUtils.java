...
public class DateTimeUtils {
	...
	/**
	 * Constants to be used in {@link DateTimeUtils#getFormattedDate(long, String)} method.
	 */
	...
	/**
	 * Gets epoch millis for a string representing a date in yyyy-MM-ddTHH:mm:ssZ format 
	 * 
	 * @param dateStr
	 * 			date in format yyyy-MM-ddTHH:mm:ss
	 * Any one-char separator can be used in place of '-', 'T' and ':'
	 */
