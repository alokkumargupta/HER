...
public class StringUtil {
	...
	public static long adjustTimeFromGMT(long date, String timeZone) {
		...
		if (date > 0 && timeZone != null) {
			...
			int o = tz.getOffset(1, c.get(Calendar.YEAR), c.get(Calendar.MONTH), c.get(Calendar.DAY_OF_MONTH),
					c.get(Calendar.DAY_OF_WEEK), (c.get(Calendar.HOUR_OF_DAY) * 60 * 60 * 1000));
			rc = date + o;
		}
		return rc;
	}
