package com.securityapp.utils.stringutils;
...
public class StringUtils {
	...
	public static String[] split(String str, char sep, int maxNum) {
		...
		Vector<String> results = maxNum == 0 ? new Vector<String>() : new Vector<String>();
	...
	public static Vector<String> splitVector(String str, char sep, int maxNum) {
		if ((str == null) || (str.length() == 0)) {
			return new Vector<String>();
		}

		Vector<String> results = maxNum == 0 ? new Vector<String>() : new Vector<String>(maxNum);
